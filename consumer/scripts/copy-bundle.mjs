...
const pkgDir = dirname(require.resolve('repro-components/package.json'));
...
console.log(`Copied custom-elements bundle from ${fromCustomElements} to ${toCustomElements}`);
